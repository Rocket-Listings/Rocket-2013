...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ListingPhoto.path'
        db.alter_column('listings_listingphoto', 'path', self.gf('django.db.models.fields.FilePathField')(path='/Volumes/Macintosh HHD/Users/Nat/workspace/Rocket-Listings-Django/media/uploads', max_length=255))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'ListingPhoto.path'
        db.alter_column('listings_listingphoto', 'path', self.gf('django.db.models.fields.FilePathField')(path='/Users/briansirkia/Documents/Rocket-Listings-Django/media/uploads', max_length=255))
