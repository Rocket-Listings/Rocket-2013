...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('listings_listingphoto', 'path', self.gf('django.db.models.fields.FilePathField')(path='/Users/teddyknox/Workspace/Python/rocketlistings/media/uploads', max_length=255))

    def backwards(self, orm):

        # Changing field 'ListingPhoto.path'
        db.alter_column('listings_listingphoto', 'path', self.gf('django.db.models.fields.FilePathField')(path='/Users/teddyknox/Workspace/Python/rocketlistings/media/uploads', max_length=100))
