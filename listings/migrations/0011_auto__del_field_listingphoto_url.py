...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'ListingPhoto.url'
        raise RuntimeError("Cannot reverse this migration. 'ListingPhoto.url' and its values cannot be restored.")
