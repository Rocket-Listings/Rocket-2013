...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('listings_listing', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=User.objects.get(username__exact='teddy').id, to=orm['auth.User']),
                      keep_default=False)
