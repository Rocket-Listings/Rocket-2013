...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ListingPhoto.url'
        db.alter_column('listings_listingphoto', 'url', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'ListingPhoto.url'
        db.alter_column('listings_listingphoto', 'url', self.gf('django.db.models.fields.CharField')(max_length=100))
