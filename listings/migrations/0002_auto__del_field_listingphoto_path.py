...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ListingPhoto.path'
        db.delete_column('listings_listingphoto', 'path')


    def backwards(self, orm):
        # Adding field 'ListingPhoto.path'
        db.add_column('listings_listingphoto', 'path',
                      self.gf('django.db.models.fields.FilePathField')(default='', path='/Users/teddyknox/Workspace/Python/rocketlistings/media/uploads', max_length=255),
                      keep_default=False)
