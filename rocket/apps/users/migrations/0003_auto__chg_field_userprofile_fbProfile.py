...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.fbProfile'
        db.alter_column(u'users_userprofile', 'fbProfile_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['users.ProfileFB'], unique=True, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'UserProfile.fbProfile'
        raise RuntimeError("Cannot reverse this migration. 'UserProfile.fbProfile' and its values cannot be restored.")
    ...
    models = {
        ...
        u'users.userprofile': {
            ...
            'fbProfile': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['users.ProfileFB']", 'unique': 'True', 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
