...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Message.listing'
        db.alter_column(u'listings_message', 'listing_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['listings.Listing']))

        # Changing field 'Message.buyer'
        db.alter_column(u'listings_message', 'buyer_id', self.gf('django.db.models.fields.related.ForeignKey')(default='1', to=orm['listings.Buyer']))
