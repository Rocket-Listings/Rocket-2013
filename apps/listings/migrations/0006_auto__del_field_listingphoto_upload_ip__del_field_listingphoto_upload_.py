...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ListingPhoto.listing'
        db.delete_column(u'listings_listingphoto', 'listing_id')

        # Adding field 'Listing.pictures'
        db.add_column(u'listings_listing', 'pictures',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=datetime.datetime(2013, 6, 26, 0, 0), to=orm['listings.ListingPhoto']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'listings_listingphoto', 'upload_ip',
                      self.gf('django.db.models.fields.IPAddressField')(default=datetime.datetime(2013, 6, 26, 0, 0), max_length=15),
                      keep_default=False)
        ...
        # Adding field 'ListingPhoto.listing'
        db.add_column(u'listings_listingphoto', 'listing',
        ...
        db.delete_column(u'listings_listing', 'pictures_id')
    ...
    models = {
        ...
        u'listings.listing': {
            ...
            'pictures': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['listings.ListingPhoto']"}),
