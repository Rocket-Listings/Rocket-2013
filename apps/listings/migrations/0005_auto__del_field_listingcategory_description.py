...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ListingCategory.description'
        db.delete_column(u'listings_listingcategory', 'description')


    def backwards(self, orm):
        # Adding field 'ListingCategory.description'
        db.add_column(u'listings_listingcategory', 'description',
