...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Listing.status'
        db.add_column(u'listings_listing', 'status',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['listings.ListingStatus'], null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Listing.status'
        db.delete_column(u'listings_listing', 'status_id')
