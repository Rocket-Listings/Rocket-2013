...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Buyer.curMaxOffer'
        db.add_column(u'listings_buyer', 'curMaxOffer',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Buyer.curMaxOffer'
        db.delete_column(u'listings_buyer', 'curMaxOffer')
    ...
    models = {
        ...
        u'listings.buyer': {
            ...
            'curMaxOffer': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
