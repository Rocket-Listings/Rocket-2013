...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'users_usercomment', 'name', self.gf('django.db.models.fields.TextField')(max_length=15))

    def backwards(self, orm):

        # Changing field 'UserComment.name'
        db.alter_column(u'users_usercomment', 'name', self.gf('django.db.models.fields.TextField')())
    ...
    models = {
        ...
        u'users.usercomment': {
            ...
            'name': ('django.db.models.fields.TextField', [], {'max_length': '15'}),
