...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserComment.name'
        db.alter_column(u'users_usercomment', 'name', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'UserComment.email'
        db.alter_column(u'users_usercomment', 'email', self.gf('django.db.models.fields.EmailField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'UserComment.name'
        db.alter_column(u'users_usercomment', 'name', self.gf('django.db.models.fields.CharField')(max_length=15))

        # Changing field 'UserComment.email'
        db.alter_column(u'users_usercomment', 'email', self.gf('django.db.models.fields.EmailField')(max_length=75))
