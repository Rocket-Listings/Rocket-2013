...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.bioprivate'
        db.add_column(u'users_userprofile', 'bioprivate',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'UserProfile.bioprivate'
        db.delete_column(u'users_userprofile', 'bioprivate')
    ...
    models = {
        ...
        u'users.userprofile': {
            ...
            'bioprivate': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
