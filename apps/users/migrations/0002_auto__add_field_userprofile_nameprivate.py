...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.nameprivate'
        db.add_column(u'users_userprofile', 'nameprivate',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.nameprivate'
        db.delete_column(u'users_userprofile', 'nameprivate')
