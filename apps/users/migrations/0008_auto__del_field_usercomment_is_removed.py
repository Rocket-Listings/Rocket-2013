...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserComment.is_removed'
        db.delete_column(u'users_usercomment', 'is_removed')


    def backwards(self, orm):
        # Adding field 'UserComment.is_removed'
        db.add_column(u'users_usercomment', 'is_removed',
